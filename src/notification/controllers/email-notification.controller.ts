...
export class EmailNotificationController {
  ...
  async sendWelcomeEmail (
    ...
    return await this.emailService.sendWelcomeEmail(dto, lang)
  }
  ...
  async sendRecoverPasswordSuccessEmail (
    ...
    return await this.emailService.sendRecoverPasswordSuccessEmail(dto, lang)
  }
  ...
  async sendTfaEmail (
    ...
    return await this.emailService.sendTfaEmail(dto, lang, ipClient)
  }
  ...
  async sendUpdateEmail (
    ...
    return await this.emailService.sendUpdateEmail(dto, lang)
  }
  ...
  async sendUpdatePassword (
    ...
    return await this.emailService.sendUpdatePassword(dto, lang)
  }
}
